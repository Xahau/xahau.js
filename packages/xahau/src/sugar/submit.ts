...
import { ValidationError, XahlError } from '../errors'
 ...
 * string (encode from xahau-binary-codec) representation of the transaction.
 ...
 *
 * @throws {XahlError} If the latest ledger sequence surpasses the transaction's lastLedgerSequence.
 *
 * @example
 * import { hashes, Client } from "xahau"
 * const client = new Client("wss://xahau-test.net")
 * await client.connect()
 *
 ...
 * a string (encode from xahau-binary-codec) representation of the transaction.
