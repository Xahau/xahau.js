...
import { verify as verifyKeypairSignature } from 'xahau-keypairs'
...
import { xahToDrops, dropsToXah } from './xahConversion'
 ...
 *
 * @param hex - hex string in the XAHL serialization format.
 * @returns The hex string decoded according to XAHL serialization format.
 */
 ...
 *
 * See https://xahau.com/build/xahaud-apis/#markers-and-pagination.
 *
