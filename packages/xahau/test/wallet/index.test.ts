...
describe('Wallet', function () {
  ...
  describe('sign', function () {
    ...
    it('sign throws when a payment contains an issued currency like XAH', async function () {
      const payment: Payment = { ...issuedCurrencyPayment }
      payment.Amount = {
        currency: 'xah',
        issuer: 'rnURbz5HLbvqEq69b1B4TX6cUTNMmcrBqi',
    ...
    it('sign does NOT throw when a payment contains an issued currency like xah in hex string format', async function () {
      const payment: Payment = { ...issuedCurrencyPayment }
      payment.Amount = {
        currency: '0000000000000000000000007861680000000000',
        issuer: 'rnURbz5HLbvqEq69b1B4TX6cUTNMmcrBqi',
        value: '123.40',
      }
      assert.deepEqual(wallet.sign(payment), {
        tx_blob:
          '',
        hash: '5653F0BCDE067F22CA1EC33BF726A8DCB9DCF347E74F3450251D28003B349309',
      })
    })
    ...
    it('sign handles non-XAH amount with a trailing zero', async function () {
      const payment: Transaction = {
        TransactionType: 'Payment',
        Account: 'r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59',
        Destination: 'rQ3PTWGLCbPz8ZCicV5tCX3xuymojTng5r',
    ...
    it('sign handles non-XAH amount with trailing zeros', async function () {
      const payment: Transaction = {
        TransactionType: 'Payment',
        Account: 'r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59',
        Destination: 'rQ3PTWGLCbPz8ZCicV5tCX3xuymojTng5r',
